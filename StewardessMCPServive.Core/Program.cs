...
startupLog.Info("StewardessMCPServive.Core starting up...");
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "StewardessMCPServive v1");
...
startupLog.Info("StewardessMCPServive.Core started.");
