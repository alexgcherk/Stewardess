...
public sealed class McpTestServer : IDisposable
{
    ...
    /// </summary>
    public McpTestServer() : this(null)
    {
    }
    ...
    internal McpTestServer(string? repositoryRoot, bool requireApiKey = false)
    {
        ...
        _ = _factory.Server;
        Settings = _factory.Services.GetRequiredService<McpServiceSettings>();
    }
    ...
    public string RepositoryRoot => Settings.RepositoryRoot;

    /// <summary>Service settings used by this test server.</summary>
    public McpServiceSettings Settings { get; }
    ...
    public McpRestClient CreateHttpClient(bool includeApiKey = true)
    {
        ...
        var apiKey = includeApiKey ? Settings.ApiKey : null;
