...
public sealed class ReferenceIndexedFixture : IDisposable
{
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description><c>Order</c> → Inherits → <c>BaseOrder</c></description>
    ///         </item>
    ///         <item>
    ///             <description><c>Order</c> → Implements → <c>IEntity</c></description>
    ///         </item>
    ///         <item>
    ///             <description><c>Order</c> → ContainsPropertyOfType → <c>BaseOrder</c> (Parent property)</description>
    ///         </item>
    ///         <item>
    ///             <description><c>Order.GetParent</c> → ReturnsType → <c>BaseOrder</c></description>
    ///         </item>
    ///         <item>
    ///             <description><c>Order.GetParent</c> → CreatesInstanceOf → <c>BaseOrder</c></description>
    ///         </item>
    ///     </list>
    /// </summary>
