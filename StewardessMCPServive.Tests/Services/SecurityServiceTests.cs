...
namespace StewardessMCPServive.Tests.Services
{
    ...
    public sealed class SecurityServiceTests : IDisposable
    {
        ...
        public SecurityServiceTests() => _repo = new TempRepository();
        ...
        {
            var svc = BuildService(apiKey: "MyKey");
        ...
        public void ValidateApiKey_SamePrefixShorterKey_ReturnsFalse()
        {
            ...
            var svc = BuildService(apiKey: "real-key-long");
        ...
        public void ValidateApiKey_OneByteOff_ReturnsFalse()
        {
            ...
            var svc = BuildService(apiKey: "abcdefgh");
        ...
        public void ValidateApiKey_EmptyKey_ReturnsFalse()
        {
            ...
            var svc = BuildService(apiKey: "some-key");
            Assert.False(svc.ValidateApiKey(""));
        }
