...
namespace StewardessMCPServive.Infrastructure
{
    ...
    public sealed class McpLogger
    {
        ...
        {
            var ev = BuildEvent(LogLevel.Info,
        ...
        {
            var level = exitCode == 0 && !timedOut ? LogLevel.Info : LogLevel.Warn;
        ...
        private LogEventInfo BuildEvent(LogLevel level, string message, Exception ex)
        {
