...
namespace StewardessMCPServive.Controllers
{
    ...
    public sealed class CommandController : BaseController
    {
        ...
        public HttpResponseMessage GetAllowedCommands()
        {
        ...
        public async Task<HttpResponseMessage> RunBuild(
        ...
        /// </summary>
        [HttpPost, Route("test")]
        public async Task<HttpResponseMessage> RunTests(
        ...
        /// </summary>
        [HttpPost, Route("run")]
        public async Task<HttpResponseMessage> RunCustomCommand(
