...
namespace StewardessMCPServive.Controllers
{
    ...
    public sealed class SearchController : BaseController
    {
        ...
        [HttpGet, Route("text")]
        public HttpResponseMessage SearchTextGet(
            [FromUri] string q,
            [FromUri] string path       = "",
            [FromUri] bool ignoreCase   = true,
            [FromUri] bool wholeWord    = false,
            [FromUri] int maxResults    = 100,
            [FromUri] int contextBefore = 2,
            [FromUri] int contextAfter  = 2)
        {
        ...
        [HttpPost, Route("text")]
        public HttpResponseMessage SearchTextPost([FromBody] SearchTextRequest request)
        {
        ...
        public HttpResponseMessage SearchRegex([FromBody] SearchRegexRequest request)
        {
        ...
        [HttpGet, Route("files")]
        public HttpResponseMessage SearchFiles(
            [FromUri] string q,
            [FromUri] string path      = "",
            [FromUri] bool ignoreCase  = true,
            [FromUri] bool fullPath    = false,
            [FromUri] int maxResults   = 100)
        {
            if (string.IsNullOrWhiteSpace(q))
        ...
        public HttpResponseMessage SearchByExtension([FromBody] SearchByExtensionRequest request)
        {
        ...
        public HttpResponseMessage SearchSymbol([FromBody] SearchSymbolRequest request)
        {
        ...
        public HttpResponseMessage FindReferences([FromBody] FindReferencesRequest request)
        {
        ...
        private HttpResponseMessage ExecuteSearch(Func<SearchResponse> fn)
        {
            try
            {
                var result = fn();
