...
namespace StewardessMCPServive.Controllers
{
    ...
    public sealed class McpController : BaseController
    {
        ...
        /// </summary>
        [HttpPost, Route("")]
        public async Task<HttpResponseMessage> Dispatch(
        ...
        /// </summary>
        [HttpGet, Route("tools")]
        public HttpResponseMessage ListTools()
        {
        ...
        public async Task<HttpResponseMessage> GetManifest(CancellationToken ct)
        {
            var tools = Registry.GetAllDefinitions();
