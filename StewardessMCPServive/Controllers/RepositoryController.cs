...
namespace StewardessMCPServive.Controllers
{
    ...
    public sealed class RepositoryController : BaseController
    {
        ...
        [HttpGet, Route("")]
        public HttpResponseMessage GetRepositoryInfo()
        {
            try
            {
        ...
        public HttpResponseMessage ListDirectory(
            [FromUri] string path = "",
            [FromUri] bool includeBlocked = false,
            [FromUri] string namePattern = null)
        {
            try
            {
        ...
        [HttpGet, Route("tree")]
        public HttpResponseMessage ListTree(
            [FromUri] string path = "",
            [FromUri] int maxDepth = 3,
            [FromUri] bool includeBlocked = false,
            [FromUri] bool directoriesOnly = false)
        {
            try
            {
        ...
        public HttpResponseMessage PathExists([FromUri] string path)
        {
        ...
        public HttpResponseMessage GetMetadata([FromUri] string path)
        {
            if (string.IsNullOrWhiteSpace(path))
                return BadRequest(ErrorCodes.MissingParameter, "'path' is required.");
            try
        ...
        public HttpResponseMessage GetSolutionInfo()
        {
            try
            {
        ...
        public HttpResponseMessage FindConfigFiles()
        {
            try
            {
