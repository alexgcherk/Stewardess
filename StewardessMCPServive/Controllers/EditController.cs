...
namespace StewardessMCPServive.Controllers
{
    ...
    public sealed class EditController : BaseController
    {
        ...
        public async Task<HttpResponseMessage> WriteFile(
        ...
        public async Task<HttpResponseMessage> CreateDirectory(
        ...
        public async Task<HttpResponseMessage> RenamePath(
        ...
        [HttpPost, Route("move")]
        public async Task<HttpResponseMessage> MovePath(
        ...
        public async Task<HttpResponseMessage> DeleteDirectory(
        ...
        public async Task<HttpResponseMessage> AppendFile(
        ...
        public async Task<HttpResponseMessage> ReplaceText(
        ...
        public async Task<HttpResponseMessage> ReplaceLines(
        ...
        public async Task<HttpResponseMessage> PatchFile(
        ...
        public async Task<HttpResponseMessage> ApplyDiff(
            [FromBody] ApplyDiffRequest request, CancellationToken ct = default)
        {
            ...
            try
            {
                ...
                var status = result.Success ? HttpStatusCode.OK : (HttpStatusCode)422;
        ...
        public async Task<HttpResponseMessage> ApplyBatchEdits(
        ...
        public async Task<HttpResponseMessage> PreviewChanges(
        ...
        public async Task<HttpResponseMessage> Rollback(
