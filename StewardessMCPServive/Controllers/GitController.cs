...
namespace StewardessMCPServive.Controllers
{
    ...
    public sealed class GitController : BaseController
    {
        ...
        [HttpGet, Route("repo")]
        public async Task<HttpResponseMessage> IsGitRepository(CancellationToken ct)
        {
            try
            {
        ...
        public async Task<HttpResponseMessage> GetStatus(
            [FromUri] string path = "", CancellationToken ct = default)
        {
            try
            {
        ...
        /// </summary>
        [HttpPost, Route("diff")]
        public async Task<HttpResponseMessage> GetDiff(
        ...
        public async Task<HttpResponseMessage> GetFileDiff(
            [FromUri] string path,
            [FromUri] string scope = "unstaged",
        ...
        public async Task<HttpResponseMessage> GetCommit(
            string sha,
            [FromUri] bool includeDiff = true,
            CancellationToken ct = default)
        {
