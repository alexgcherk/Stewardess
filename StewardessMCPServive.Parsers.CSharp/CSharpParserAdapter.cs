...
using IndexDiagSeverity = StewardessMCPServive.CodeIndexing.Model.Diagnostics.DiagnosticSeverity;
using IndexDiagSource = StewardessMCPServive.CodeIndexing.Model.Diagnostics.DiagnosticSource;
using LangId = StewardessMCPServive.CodeIndexing.LanguageDetection.LanguageId;

namespace StewardessMCPServive.Parsers.CSharp;
