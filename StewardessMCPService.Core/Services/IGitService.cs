...
public interface IGitService
{
    ...
    Task<GitDiffResponse> GetDiffForFileAsync(string relativePath, string scope = "unstaged",
    ...
    Task<ApiCommit> CreateCommitAsync(string message, string authorName, string authorEmail,
    ...
    Task<ApiCommit> MergeBranchAsync(string sourceBranch, string targetBranch, string strategy,
        CancellationToken ct = default);
