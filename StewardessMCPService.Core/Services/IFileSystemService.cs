...
public interface IFileSystemService
{
    ...
    Task<ReadMultipleFilesResponse> ReadMultipleFilesAsync(ReadMultipleFilesRequest request,
    ...
    /// </summary>
    Task<FileStructureSummaryResponse> GetFileStructureSummaryAsync(FileStructureSummaryRequest request,
        CancellationToken ct = default);
