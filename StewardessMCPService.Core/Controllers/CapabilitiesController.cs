...
public sealed class CapabilitiesController : BaseController
{
    ...
    private McpCapabilitiesManifest BuildManifest()
    {
        ...
        return new McpCapabilitiesManifest
        {
            ...
            {
                RepositoryName = Path.GetFileName(settings.RepositoryRoot),
                    ...
                    error = new
                    {
                        ...
                        properties = new
                        {
                            Code = new
                            {
                                ...
                                @enum = new[]
                                {
                                    "ValidationError", "SnapshotNotFound", "FileNotFound", "SymbolNotFound",
                                    "CapabilityNotSupported", "RepositoryNotIndexed", "InternalError"
                                }
                            },
                            ...
                            Context = new
                            {
                                type = "object",
                                description =
                                    "Optional structured context about the error (e.g. which parameter was invalid)."
                            }
                        },
    ...
    private sealed class ToolListBuilder
    {
        ...
        {
            var enabled = !destructive || _canWrite;
        ...
        public List<McpToolDefinition> Build()
        {
            return _tools;
        }
        ...
        {
            return (name, false, new McpPropertySchema
            {
                Type = type, Description = description, Default = def!,
        ...
        {
            return (name, true, new McpPropertySchema
            {
