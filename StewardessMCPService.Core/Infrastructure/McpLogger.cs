...
public sealed class McpLogger
{
    ...
    {
        return new McpLogger(LogManager.GetLogger(typeof(T).FullName), null, null);
    }
    ...
    {
        return new McpLogger(LogManager.GetLogger(typeof(T).FullName), requestId, sessionId);
    }
