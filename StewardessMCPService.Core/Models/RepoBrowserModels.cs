...
public sealed class RepoBrowserTreeResponse
{
    ...
    public List<RepoBrowserTreeItem> Items { get; set; } = new();
}
...
public sealed class RepoBrowserGrepResponse
{
    ...
    public List<RepoBrowserGrepMatch> Items { get; set; } = new();
}
...
public sealed class RepoBrowserGrepMatch
{
    ...
    public List<string> BeforeContext { get; set; } = new();

    /// <summary>Context lines immediately after the match.</summary>
    public List<string> AfterContext { get; set; } = new();
}
...
public sealed class RepoBrowserFindPathResponse
{
    ...
    public List<RepoBrowserPathMatch> Items { get; set; } = new();
}
...
public sealed class RepoBrowserSearchResponse
{
    ...
    public List<RepoBrowserSearchMatch> Items { get; set; } = new();
}
