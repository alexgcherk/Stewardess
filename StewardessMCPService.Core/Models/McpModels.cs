...
public sealed class McpResponse
{
    ...
    {
        return new McpResponse { Id = id, Error = new McpError { Code = code, Message = message, Data = data } };
    }
}
...
public sealed class McpToolDefinition
{
    ...
    /// <summary>
    ///     Side effect class: "read-only", "file-write", "process-execution", "git-mutation", "destructive",
    ///     "service-state-write".
    /// </summary>
...
public sealed class McpContent
{
    ...
    {
        return new McpContent { Type = "text", Text = "ERROR: " + message };
    }
}
