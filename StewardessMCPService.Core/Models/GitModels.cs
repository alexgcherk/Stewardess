...
public sealed class GitStatusResponse
{
    ...
    public List<GitStatusEntry> Files { get; set; } = new();
...
public sealed class GitStatusEntry
{
    ...
    public string WorkTreeStatus { get; set; } = null!;
...
public sealed class GitLogResponse
{
    ...
    public List<GitLogEntry> Commits { get; set; } = new();
...
public sealed class GitLogEntry
{
    ...
    public string CommitterName { get; set; } = null!;
...
public sealed class GitShowResponse
{
    ...
    public string CommitterEmail { get; set; } = null!;
...
public sealed class ProjectInfo
{
    ...
    public List<string> NuGetReferences { get; set; } = new();
...
public sealed class ConfigFilesResponse
{
    ...
    public List<string> JsonConfigs { get; set; } = new();

    /// <summary>Paths of .yaml / .yml configuration files.</summary>
    public List<string> YamlConfigs { get; set; } = new();
    ...
    public List<string> OtherConfigs { get; set; } = new();
}