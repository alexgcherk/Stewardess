...
";
    ...
    public void ParseShowOutput_ValidOutput_ParsesAllFields()
    {
        ...
        var sep = "\x1F";
        var line = string.Join(sep, "deadbeefdeadbeefdeadbeefdeadbeefdeadbeef", "deadbee", "Bob", "bob@example.com",
            "2024-06-01T09:30:00+00:00", "Bob", "bob@corp.example", "2024-06-01T09:30:00+00:00", "Add feature X",
            "Longer description here", "abc1234");
    ...
    {
        var sep = "\x1F";
        var line = string.Join(sep, "aaaa1111aaaa1111aaaa1111aaaa1111aaaa1111", "aaaa111", "Carol", "carol@x",
            "2024-07-01T00:00:00+00:00", "Carol", "carol@x", "2024-07-01T00:00:00+00:00", "Merge feature", "",
    ...
    public void ParseLogOutput_SingleCommit_ParsesFields()
    {
        ...
        var sep = "\x1F";
        var line = string.Join(sep, "abc1234abc1234abc1234abc1234abc1234abc1234", "abc1234", "Alice",
            "alice@example.com", "2024-01-15T10:00:00+00:00", "Alice", "2024-01-15T10:00:00+00:00", "Fix bug in parser",
            "", "");
