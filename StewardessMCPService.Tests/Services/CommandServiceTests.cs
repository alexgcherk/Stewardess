...
namespace StewardessMCPService.Tests.Services
{
    ...
    internal sealed class MockAuditService : StewardessMCPService.Services.IAuditService
    {
        public System.Threading.Tasks.Task LogAsync(
            StewardessMCPService.Models.AuditEntry entry,
        ...
        public System.Threading.Tasks.Task<StewardessMCPService.Models.AuditLogQueryResponse> QueryAsync(
            StewardessMCPService.Models.AuditLogQueryRequest request,
            CancellationToken ct = default)
            => System.Threading.Tasks.Task.FromResult(new StewardessMCPService.Models.AuditLogQueryResponse());
    }
}
