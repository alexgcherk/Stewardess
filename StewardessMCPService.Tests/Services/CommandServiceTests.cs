...
public sealed class CommandServiceTests : IDisposable
{
    ...
    {
        return new CommandService(
            McpServiceSettings.CreateForTesting(root, true),
            new PathValidator(McpServiceSettings.CreateForTesting(root, true)),
...
internal sealed class MockAuditService : IAuditService
{
    ...
    public Task LogOperationAsync(
        ...
        AuditOutcome outcome, string? errorCode,
    ...
    public Task<AuditLogQueryResponse> QueryAsync(
