...
namespace StewardessMCPService.Tests.Mcp
{
    ...
    public sealed class McpToolSchemaFixTests : IDisposable
    {
        ...
        private sealed class StubIndexQueryService : IIndexQueryService
        {
            ...
            public Task<StewardessMCPService.CodeIndexing.Model.Snapshots.IndexSnapshot?> GetSnapshotAsync(string? snapshotId, string? rootPath, CancellationToken ct = default)
                => Task.FromResult<StewardessMCPService.CodeIndexing.Model.Snapshots.IndexSnapshot?>(null);
