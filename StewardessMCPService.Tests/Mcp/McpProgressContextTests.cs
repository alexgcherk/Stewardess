...
namespace StewardessMCPService.Tests.Mcp
{
    ...
    public sealed class McpProgressContextTests
    {
        ...
        public void ReportProgress_InvokesReporterWithCorrectValues()
        {
            ...
            Assert.Equal(0.3,        received[0].Progress, precision: 3);
            Assert.Equal(1.0,        (double)received[0].Total!, precision: 3);
        ...
        public void ReportProgress_NullMessageIsAccepted()
        {
            ...
            McpProgressContext.ReportProgress(1.0, 1.0, null);
        ...
        public async Task Current_CanBeRestoredAfterToolCall()
        {
            ...
            IProgress<McpProgressEvent>? prev = McpProgressContext.Current;
