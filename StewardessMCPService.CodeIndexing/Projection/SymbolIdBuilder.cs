...
public static class SymbolIdBuilder
{
    ...
    {
        return $"{languageId}:{repoScope}:{kindCategory}:{qualifiedName}";
    }
    ...
    public static string BuildSymbolKey(
        string languageId, string repoScope, string kindCategory, string qualifiedName)
    {
        return $"{repoScope}|{languageId}|{kindCategory}|{qualifiedName}";
    }
    ...
    public static string GetKindCategory(SymbolKind kind)
    {
        return kind switch
        {
